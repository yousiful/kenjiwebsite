...
const holidays: Holiday[] = [
  {
    ...
    offer_text: 'Start 2025 strong - Special launch pricing',
    offer_badge: 'LIMITED TIME',
    urgency_text: 'Ends January 15th',
    is_active: true,
    priority: 10
  },
  {
  ...
  },
  {
    ...
    offer_text: 'MASSIVE Black Friday savings on automation',
    offer_badge: 'BLACK FRIDAY',
    urgency_text: 'This weekend only',
    is_active: true,
    priority: 10
  },
  {
    ...
    offer_text: 'Ultimate tech savings - Cyber Monday exclusive',
    offer_badge: 'CYBER MONDAY',
  ...
  },
  {
    ...
    offer_text: 'Give your business the gift of automation',
    offer_badge: 'HOLIDAY SPECIAL',
    urgency_text: 'Until Christmas',
    is_active: true,
    priority: 10
  },
  {
    ...
    offer_text: 'Year-end special - Automate before midnight',
    offer_badge: 'NEW YEAR\'S EVE',
    urgency_text: 'Before the new year',
    is_active: true,
    priority: 10
  }
];
