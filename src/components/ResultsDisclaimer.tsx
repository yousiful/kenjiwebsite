          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 sm:p-6 max-w-7xl mx-auto">
                <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                                  <h3 className="text-sm sm:text-base font-bold text-yellow-400 mb-2">Important Disclaimer: Results May Vary</h3>h3>
                                  ...
                                  <p className="text-xs sm:text-sm text-gray-300 leading-relaxed">
                                              <strong className="text-yellow-400">We make no guarantees regarding your potential results, earnings, or business outcomes.</strong>strong> Your success depends entirely on your own efforts, decisions, and circumstances. Please review our full <Link to="/disclaimer" className="text-blue-400 hover:text-blue-300 underline">disclaimer</Link>Link> for complete details.
                                  </p>p>
                        </div>div>
                </div>div>
          </div>div>
