...
const FAQ: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes. Monthly and annual plans can both be cancelled anytime with no penalties or fees. We never lock you into long-term contracts you can't get out of."
    },
    {
    ...
    },
    {
      ...
      answer: "Over 500 businesses run on this system: agencies, CPAs, tax relief firms, coaches, contractors, and local services. The playbooks we install for you are the ones already producing sales in niches like yours, not experiments. If you want to see it mapped to your exact business first, book a free strategy call and we'll walk you through it."
    },
    {
