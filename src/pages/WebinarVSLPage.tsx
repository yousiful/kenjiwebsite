        ...
        <div className="min-h-screen bg-[#0B0E14] text-white flex justify-center py-12 px-4 font-sans">
          ...
          <div className="relative w-full aspect-video bg-black rounded-b-2xl overflow-hidden shadow-[0_20px_40px_-10px_rgba(59,130,246,0.5)] border border-white/10 border-t-0 z-10">
            <div className="absolute top-0 left-0 w-full h-[70px] z-20 bg-transparent pointer-events-auto" />
              <iframe src="https://www.youtube.com/embed/J-AURUyzSks?si=tQ2wmu_OYYE0IMnP&controls=0&autoplay=1&rel=0&modestbranding=1&disablekb=1" title="YouTube overview" className="absolute top-0 left-0 w-full h-full border-0 pointer-events-auto" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />
            </div>
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1, duration: 0.8 }} className="mt-12 text-center">
            <p className="text-gray-400 text-sm sm:text-base font-medium max-w-2xl mx-auto mb-8">To work with us on a strictly performance basis, you must book your onboarding call and actually show up. If you miss your call again, this offer will be voided.</p>
            <div className="flex flex-col items-center gap-6">
              <a href="https://go.mediatraffics.com/leads" target="_blank" rel="noopener noreferrer" className="group relative flex flex-col items-center justify-center w-full max-w-[500px] px-8 py-5 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-500 text-white shadow-[0_10px_25px_-5px_rgba(59,130,246,0.4)] hover:shadow-[0_15px_35px_-5px_rgba(59,130,246,0.6)] hover:-translate-y-1 transition-all duration-300 border border-white/20">
